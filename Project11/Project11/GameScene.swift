...
//        bouncerYLocations = [0, 150, 300, 450]
//        
//        for coordinate in bouncerYLocations {
//            makeBouncerAt(CGPoint(x: 0, y: coordinate))
//            makeBouncerAt(CGPoint(x: 256, y: coordinate))
//            makeBouncerAt(CGPoint(x: 512, y: coordinate))
//            makeBouncerAt(CGPoint(x: 768, y: coordinate))
//            makeBouncerAt(CGPoint(x: 1024, y: coordinate))
//        }
        ...
        if let touch = touches.first as? UITouch {
            ...
            if contains(objects, editLabel) {
                ...
                if editingMode {
                    ...
                    ball.physicsBody!.restitution = 0.40
                    ball.position = CGPoint(x: location.x, y: UIScreen.mainScreen().bounds.height)
                    addChild(ball)
                }
            }
        }
    ...
    func makeSlotAt(position: CGPoint, isGood: Bool) {
        ...
        let spin = SKAction.rotateByAngle(CGFloat(M_PI * 2.0), duration: 10)
